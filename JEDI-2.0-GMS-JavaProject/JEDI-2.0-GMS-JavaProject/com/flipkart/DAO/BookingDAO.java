...
public class BookingDAO {
    ...
    public void  addBooking(int userId, int scheduleID) throws BookingFailedException{
        try {
    ...
    public List<Booking> getBookingByCustomerId(int customerId) throws BookingFailedException {
    ...
    public boolean checkBookingOverlap(int customerId, Date date, LocalTime localTime){
    ...
    public void cancelBookingById(int bookingID) throws BookingFailedException {
        try {
            Connection conn = DBConnection.connect();
    ...
    public Booking getBookingByBookingId(int bookingId) throws BookingFailedException{
